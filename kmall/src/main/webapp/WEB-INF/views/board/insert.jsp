...
<!--           			<label for="mem_id col-md-4">작성자</label> -->
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="boa_title" name="boa_title" placeholder="제목을 입력하세요.">
                </div>
                <div class="form-group">
                	<label for="boa_content">Content</label>
             	    <textarea class="form-control" rows="3" id="boa_content" name="boa_content" placeholder="내용을 입력하세요"></textarea>
                </div>
              </div>
              <!-- /.box-body -->
