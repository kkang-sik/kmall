        ...
        <div class="row border-top pt-3">
          ...
          <div class="row pt-3">
            ...
            <div class="col-md-10">
              ...
              <input type="text" class="form-control" name="d_mem_email" id="d_mem_email" value="${memberVO.mem_email }">
            </div>
          </div>
          <div class="row pt-3">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
              <input type="text" class="form-control" name="d_mem_phone" id="d_mem_phone" value="${memberVO.mem_phone }">
            </div>
          </div>
          <hr>
          <h4 class="mb-3">수령자정보</h4>
          ...
          <div class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input" name="mem_receive" id="mem_receive">
            <label class="custom-control-label" for="mem_receive">개인정보 수집 및 이용에 동의합니다.</label>
          </div>
